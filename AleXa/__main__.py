...
PM_START_TEXT = """
𝙃𝙚𝙡𝙡𝙤 𝙩𝙝𝙚𝙧𝙚, 𝙄'𝙢 [ᗩᑎKI ᐯEᑕTOᖇ](t.me/AleXaUpdates) 🍑
𝙄'𝙢 𝙖 𝙋𝙤𝙬𝙚𝙧𝙛𝙪𝙡 𝙜𝙧𝙤𝙪𝙥 𝙢𝙖𝙣𝙖𝙜𝙚𝙧 𝙗𝙤𝙩 𝙒𝙞𝙩𝙝 𝘾𝙤𝙤𝙡 𝙈𝙤𝙙𝙪𝙡𝙚𝙨. 𝙈𝙖𝙙𝙚 𝙗𝙮 [TEᗩᗰ ᗩᑎKI ᐯEᑕTOᖇ](t.me/TeamAleXa)
...
buttons = [
    [
        InlineKeyboardButton(text="📌ᴜᴘᴅᴀᴛᴇꜱ ᴄʜᴀɴɴᴇʟ", url="https://t.me/AleXaUpdates"),
    ...
    [
        ...
        InlineKeyboardButton(text="❔ ʜᴇʟᴘ", url="http://t.me/TheAleXabot?start=help"),
    ],
    [
        InlineKeyboardButton(
            text="➕ ᴀᴅᴅ ᴀɴᴋɪ ᴠᴇᴄᴛᴏʀ ᴛᴏ ʏᴏᴜʀ ɢʀᴏᴜᴘ ➕", url="t.me/TheAleXabot?startgroup=true"
        ),
    ],
]


AleXa_IMG = "https://telegra.ph/file/75579c20520fc79f5b68d.jpg"
...
def AleXa_about_callback(update, context):
    ...
    if query.data == "aboutmanu_":
        query.message.edit_text(
            ...
            f"\n\n Join [AleXaUpdates](https://t.me/AleXaUpdates) To Keep Yourself Updated About {dispatcher.bot.first_name}"
